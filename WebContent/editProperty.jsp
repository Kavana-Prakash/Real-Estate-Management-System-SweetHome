...
if(user==null){
   ...
   Property p=dao.getPropertybypropertyid(propid);
 ...
 <div class="row mt-4">
   <div class="col-md-12">
             ...
             <div class="container">
                   ...
                   <div class="col-md-8 offset-md-2">
                     <div class="card">
                       <div class="card-header">
                          <h4>Property Details of property-<%= propid %></h4>
                       </div>
                       <div class="card-body">
                            <div id="profile-edit">
                          <h3 class="mt-2">Please Edit Carefully</h3>
                              <form action="EditProperty" method="post" enctype="multipart/form-data">
                                <table class="table">
                                 <tr>
                                  <td>Type</td>
                                  <td><select id="proptype" name="proptype" class="form-control">
                                   <% 
                                  ...
                                  <tr>
                                    <td>Propid:</td> 
                                    <td><input type="text" class="form-control" id="propprice" name="propid" value="<%=propid%>" required></td>
                                 </tr>
                                  
                                 <tr>
                                  <td>Square Feet</td>
                                  <td> <select id="propsqft" name="propsqft" class="form-control">
                                 ...
                                 <tr>
                                    <td>Ownerid:</td> 
                                    <td><input type="text" class="form-control" id="propprice" name="propoid" value="<%=p.getOwnerid() %>" required></td>
                                 </tr>
        
                                 <tr>
                                    <td>Price:</td> 
                                    <td><input type="text" class="form-control" id="propprice" name="propprice" value="<%=p.getPrice() %>" required></td>
                                 </tr>
              
                                 <tr>
                                  <td>Street:</td> 
                                  <td><input type="text" class="form-control" id="propstreet" name="propstreet" value="<%=p.getStreet()%>" required></td>
                                </tr>
           
                                  <tr>   
                              <td>City</td>
                                 <td><input type="text" class="form-control" name="propcity" value="<%=p.getCity()%>"></td>
                               </tr>
        
                              <tr>
                              <td>State</td>
                               <td><select id="propstate" name="propstate" class="form-control">
                                  <option value="Karnataka" >Karnataka</option>
                                  <option value="Andhra Pradesh">Andhra Pradesh</option>
                                  <option value="Kerala">Kerala</option>
                                  <option value="Tamil Nadu">Tamil Nadu</option>
                           ...
                           <tr>
                           <td>Pincode</td>
                             <td><input type="text" class="form-control" name="proppincode" value="<%=p.getPincode()%>"></td>
                           </tr>
        
                             <tr>
                               <td>Room</td>
                               <td><select name="propbedroom" id="propbedroom" class="form-control">
                             ...
                             <tr>
                              <td>Bathroom</td>
                                <td><select name="propbathroom" id="propbathroom" class="form-control">
                                 <option value="0">0</option>
                                  <option value="1">1</option>
                                  <option value="2">2</option>
                                  <option value="3 or more">3 or more</option>
                           ...
                           <tr>
                          <td>Age</td>
                            <td><select name="propage" id="propage" class="form-control">
                         <option value="0">0</option>
                         <option value="1">1</option>
                         <option value="2">2</option>
                         <option value="3 or more">3 or more</option>
                       ...
                       <tr>
                        <td>Balcony</td>
                         <td><select name="propbalcony" id="propbalcony" class="form-control">
                         <option value="0">0</option>
                         <option value="1">1</option>
                         </select></td>
                       </tr>
                     ...
                     <tr>
                    <td>Pool</td>
                     <td><select name="proppool" id="proppool" class="form-control">
                ...
                <tr>
                 <td>Backyard</td>
                 <td><select name="propbackyard" id="propbackyard" class="form-control">
                         <option value="0">Present</option>
                         <option value="1">Not Present</option>
                    </select></td>
                 </tr>
                ...
                <tr>
                  <td>Garage</td>
                    <td><select name="propgarage" id="propgarage" class="form-control">
                         <option value="0">Present</option>
                         <option value="1">Not Present</option>
                    </select></td>
               </tr>
              ...
              <td>Property Image</td>
               <td><input type="file" class="form-control" name="propimage" value="<%=p.getImg()%>" accept="image/*"></td>
              </tr>
        
               <tr>
                <td>Description</td>
              <td>
             <textArea class="form-control" name="propdescription" rows="5"><%=p.getText()%>
             </textArea>
             </td>
           </tr>
       </table>
...
<script>
$(document).ready(function(){
localStorage.setItem("Select5","<%= p.getState()%>");
$('#propstate').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select5")){
		 $('#propstate').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select2","<%= p.getBedroom()%>");
$('#propbedroom').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select2")){
		 $('#propbedroom').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select3","<%= p.getBathroom()%>");
$('#propbathroom').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select3")){
		 $('#propbathroom').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select4","<%= p.getType()%>");
$('#proptype').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select4")){
		 $('#proptype').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select6","<%= p.getSquarefeet()%>");
$('#propsqft').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select6")){
		 $('#propsqft').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select7","<%= p.getAge()%>");
$('#propage').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select7")){
		 $('#propage').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select8","<%= p.getBalcony()%>");
$('#propbalcony').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select8")){
		 $('#propbalcony').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select9","<%= p.getBackyard()%>");
$('#propbackyard').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select9")){
		 $('#propbackyard').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select10","<%= p.getPool()%>");
$('#proppool').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select10")){
		 $('#proppool').prop('selectedIndex',i);
	 }
});
localStorage.setItem("Select11","<%= p.getGarage()%>");
$('#propgarage').find('option').each(function(i,e){
	 if($(e).val()==localStorage.getItem("Select11")){
		 $('#propgarage').prop('selectedIndex',i);
	 }
});
});
</script>
