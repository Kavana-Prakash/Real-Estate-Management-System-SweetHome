...
<%UserDao udao=new UserDao(ConnectionProvider.getConnection());
  List<User> userlist=udao.selectAllUser();
%>
             ...
             <div class="card-columns">
                <%
                 ...
                 <div class="card" onmouseover="this.style.background='#e2e2e2';" onmouseout="this.style.background='white';">
                      ...
                      <img src="pics/<%= u.getProfile()%>" class="card-img-top" style="border-radius:50%; max-width: 150px;">
                     </div>  
                    ...
                    <div class="card-footer" onMouseOver="this.style.cursor='pointer'">
                      <a class="btn btn-outline-dark" href="showuser.jsp?userid=<%=u.getId()%>">Get more details</a>
                      <a class="btn btn-dark text-white" href="EditUser.jsp?userid=<%=u.getId()%>">edit</a>
                      <a class="btn btn-danger" href="<%=request.getContextPath() %>/DeleteUser?userid=<%=u.getId()%>">Delete</a>
                 </div>
                 </div>
                 <%}%>
             </div>
