...
<div class="container-fluid">
 <div class="row mt-3 mx-2">
  ...
  %>
  <a href="SHOWALLPROPERTY.jsp?category=<%=c.getCategory_name()%>" class="list-group-item list-group-item-action" onmouseover="this.style.background='#e2e2e2';" onmouseout="this.style.background='white';"><%=c.getCategory_name()%></a>
  <%} %>
  </div>
</div>
   <div class="col-md-10">
