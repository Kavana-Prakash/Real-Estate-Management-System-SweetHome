                 ...
                 <div class="row my-4">
                   <div class="col-md-8 offset-md-2">
                     <div class="card">
                       ...
                       <h5 class="modal-title mt-3" id="exampleModalLabel"><%= s.getUsername() %></h5>
                       </div>
                       <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <th scope="row">Name</th>
                    <td><%=s.getFirstname()%> <%=user.getLastname() %></td>
                  </tr>
